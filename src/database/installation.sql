-- ---------------------------------------------------------------------------------------------
-- CREATE `bg_merchant` SCHEMA.
-- ---------------------------------------------------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `bg_merchant` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
-- ---------------------------------------------------------------------------------------------
-- SET `bg_merchant` AS DEFAULT SCHEMA.
-- ---------------------------------------------------------------------------------------------
USE `bg_merchant`;
-- ---------------------------------------------------------------------------------------------
-- DROPPING ALL TABLES.
...
(
    ...
    CONSTRAINT `orders_order_number_uq` UNIQUE KEY (`order_number`)
)
    ENGINE = InnoDB
...
(
    ...
    CONSTRAINT `items_order_id_alias_number_uq` UNIQUE KEY (`order_id`, `alias_number`),
